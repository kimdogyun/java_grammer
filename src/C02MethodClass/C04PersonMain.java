...
//        위 코드는 요소(속성)들이 그룹화되어 있지 않다보니, 중복과 코드의 가독성이 저하
...
//        System.out.println("이름은" + name + "email은" + email + "나이는" + age + "입니다");
    }
    public static void printMember2(C04Person person) { //객체의 주소값이 매개변수로 전달
        System.out.println("이름은 " + person.getName() + " email은 " + person.getEmail() + " 나이는 " + person.getAge() + " 입니다");
