...
//            }
//        };
//        인터페이스의 익명객체에 구현해야할 메서드가 1개밖에 없을떄에는 람다표현식(화살표함수) 사용가능
//        Animal2 a2_1 =()->{
...
//        실습)
//        Animal4인터페이스 생성 및 makesound 메서드 선언 : 매개변수는 String,String,int,리턴타입은 String
//        익명객체 생성시 메서드의 기능 : 매개변수의 숫자값이 10이상이면 a+b 리턴,10미만이면 a만 리턴
        Animal4 a4 = (a, b, c) -> {
            if(c>=10){
                return  a+b;
            }else{
