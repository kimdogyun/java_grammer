...
//        String input = myScanner.nextLine(); //입력받은 데이터를 한줄롱 읽어서,Stringㅇ으로 리턴
...
//        int input3 = Integer.parseInt(myScanner.nextLine()); // 입력받은 문자열을 직접 형변화(추천하는방식)
...
//
////        close()는 메모리회수. 외부입출력장치와연계된코드이므로, GC(가비지컬렉터)의 대상이 아님
//        br.close();
