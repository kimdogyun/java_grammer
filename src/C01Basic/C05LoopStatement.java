...
//            c++;
//            if(c>10){
////                break 키워드를 통해 가장 가까이에 있는 반복을 즉시종료
//                break;
//            }
//        }
//        반복되는 도어락키 예제
//        만약 비밀벚호를 맞추면 즉시 종료 - > 문이 열렸습니다 출력
//        5회입력을 초과할 떄까지 맞추지 못하면 종료 -> 비밀번호 5회초과 출력
...
//    }
//              }
//              립력한 숫자의 구구단 단수 출력 ex)2를 입력 -> 2X1 =2 2X2=4...2X9=18
//        Scanner sc = new Scanner(System.in);
...
//        for문 : 초기식, 조건식, 증감식이 모두 포함돼 있느 반복문
//        for(int i=0; i<10;i++){
//            System.out.println("hello world");
