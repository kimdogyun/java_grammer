...
//        indexOf : 특정값을 찾아 index return(가장먼저나오는값)
//        List<Integer> myList = new ArrayList<>();
//        myList.add(10);
//        myList.add(20);
//        myList.add(30);
...
//        [{10,20}.{1,2,3},{4,3,2,1}]
        ...
        arr[1]= 20;
        myList.add(arr);
        myList.add(new int[3]); //방법2
        myList.get(1)[0]=1;
        myList.get(1)[1]=2;
        myList.get(1)[2]=3;
        myList.add(new int[]{4,3,2,1}); //방법3
        System.out.println(myList);//배열주소값이 출력. [x1 배열의주소,x2 배열의주소,x3 배열의주소]
        for(int i =0; i<myList.size(); i++){
